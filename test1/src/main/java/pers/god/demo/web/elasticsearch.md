...
修改权限：chown leyou:leyou elasticsearch-6.2.4.tar.gz
...
http://localhost:8080/collections?action=create&nunber_of_shards=3
...
如果存储的是String类型数据，ES无智能判断，它就会存入两个字段。例如：
